...
var option=new Array("define","const","def","constant","Preprocessed Hypertext page","Hypertext Preprocesser","Hypertext Markup Language","Hypertext Transfer Protocol","!=","<=>",">=","<>","Register global variable","Initialize Session","Store Variable of current session","none of the above","1MB","2MB","2.5MB","3MB","$DOMAIN","$GLOBALS","$_ENV","$REMOTE_ADDR","Mozilla","microsoft","apple","World Wide Web Consortium","H1","H2","H3","H6","OI","DI","UI","List","OI","DI","UI","List");
